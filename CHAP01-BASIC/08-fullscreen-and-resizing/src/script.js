...
/**
 * Sizes
 * To make the canvas fit perfectly in the viewport, instead of using fixed numbers in the sizes variable
 * Can use the window.innerWidth and window.innerHeight
 */
const sizes = {
